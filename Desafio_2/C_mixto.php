...
<body class="bg-gradient-to-br from-indigo-50 via-white to-teal-50 min-h-screen p-8 font-sans">
    ...
    <div class="grid md:grid-cols-3 gap-8">
        ...
        $iconos_niveles = ["Básico" => "book", "Intermedio" => "book-open", "Avanzado" => "library"];
        $iconos_idiomas = ["Inglés" => "flag", "Francés" => "flag", "Mandarín" => "globe", "Ruso" => "globe", "Portugués" => "flag", "Japonés" => "globe"];
        ...
        foreach ($alumnos as $nivel => $idiomas) {
            ...
            echo "<h2 class='text-2xl font-semibold text-indigo-600 mb-4 flex items-center gap-2'>
                    <i data-lucide='{$iconos_niveles[$nivel]}' class='w-6 h-6 text-indigo-400'></i> Nivel $nivel
            ...
            foreach ($idiomas as $idioma => $cantidad) {
                echo "<li class='flex items-center justify-between px-3 py-2 bg-indigo-50 rounded-lg shadow-sm'>
                        <span class='flex items-center gap-2 text-gray-700'>
                            <i data-lucide='{$iconos_idiomas[$idioma]}' class='w-5 h-5 text-indigo-500'></i> $idioma
                        </span>
